...
<head>
   ...
   <title>街坊邻里后台管理系统 - 设备管理</title>
    <meta name="keywords" content="门禁,安防">
    <meta name="description" content="街坊邻里后台管理系统 - 设备管理">
                ...
                <div class="text-left animated fadeInRightBig form-horizontal">
                	<div class="form-group">
                		<div class="form-inline col-sm-3">
                			<div class="form-group">
		                         <label for="residentialQuarterValue">所属小区：</label>
		                ...
		                <div class="form-inline col-sm-3">
                			<div class="form-group">
		                         ...
		                         <input type="text" class="form-control" style="width:70px;" name="minVoltage" id="minVoltage" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" >
		                         	V~
		                         <input type="text" class="form-control" style="width:70px;" name="maxVoltage" id="maxVoltage" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" >
		                         	V
		                    </div>
		                </div>
                    </div>
                    <div class="form-group">
		                ...
		                <div class="form-inline col-sm-3">
                			<div class="form-group">
		                         ...
		                         <input type="text" class="form-control" style="width:70px;" name="minElectricity" id="minElectricity" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" >
		                         	A~
		                         <input type="text" class="form-control" style="width:70px;" name="maxElectricity" id="maxElectricity" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" >
		                         	A
		                    </div>
		                </div>
                    	...
                    	<div class="form-inline col-sm-3">
		                    <div class="form-group">
		                         ...
		                         <select class="form-control" name="deviceType" id="deviceType">
	                                 <option value="">--所有--</option>
	                                 <option value="0">考勤读卡器</option>
	                                 <option value="1">门禁读卡器</option>
	                             </select>
		                    </div>
		                </div>
		                <div class="form-inline col-sm-2 text-right">
...
<!--	<script src="${ctx  }/js/plugins/ztree/jquery.ztree.exedit.js"></script>-->
	...
	<script src="${ctx  }/js/system/device_management.js"></script>
	<script>
