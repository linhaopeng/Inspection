...
<head>
   ...
   <title>街坊邻里后台管理系统 - 物业单位管理</title>
    <meta name="keywords" content="门禁,安防">
    <meta name="description" content="街坊邻里后台管理系统 - 物业单位管理">
...
<body class="gray-bg">
                ...
                <div class="text-center animated fadeInRightBig form-horizontal">
                	<div class="form-group">
                		 <div class="form-inline col-sm-4">
                			<div class="form-group">
		                         <label for="companyNameValue">物业单位名称：</label>
                    ...
                    <div class="form-group">
                         <div class="form-inline col-sm-4">
                			<div class="form-group">
		                         <label for="companyAddressValue">物业单位地址：</label>
                    ...
                    <div class="form-group">
                    	<div class="col-sm-12 text-left">
	                         ...
	                         <button type="button" class="btn btn-w-m btn-info excelImport_btn">批量导入物业单位</button>
	                         <input type="file" id="propertyUnits_file" name="propertyUnits" style="display: none;">
	                         <button type="button" class="btn btn-w-m btn-dafault cancelImport_btn" style="display:none;">取消</button>
	                         <a href="${ctx }/excelImport/propertyUnitsExcel2003Temp.do">
					...
					<div class="ibox-content">
						<table class="footable table table-stripped toggle-arrow-tiny text-left"
							data-page-size="8" id="propertyUnitTable" >
							<thead>
								<tr>
			...
			<div class="modal-dialog">
				<form class="modal-content animated fadeInDown" id="companyForm">
					<div class="modal-header" style="padding: 10px;">
						...
						<h6 class="modal-title">新增物业单位</h6>
					</div>
					<div class="modal-body">
						<div class="form-group">
						  ...
						  <div class="form-group">
						    <label for="companyName">物业单位名称：</label>
						    <input type="text" class="form-control" id="companyName" name="companyName" placeholder="请输入物业单位名称">
						  </div>
						  <div class="form-group">
	...
	<script src="${ctx  }/js/system/property_unit_management.js"></script>
